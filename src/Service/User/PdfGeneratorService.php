...
class PdfGeneratorService
{
     ...
     *
     * @param array<int, SolutionTraitement> $traitements
     */
    public function generateMaladiePdf(Maladie $maladie, array $traitements): string
    {
     ...
     */
    public function generateDiagnosticPdf(Maladie $maladie, SolutionTraitement $traitement, string $userDescription): string
    {
