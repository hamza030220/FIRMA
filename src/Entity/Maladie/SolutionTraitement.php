...
class SolutionTraitement
{
    ...
    #[ORM\JoinColumn(name: 'maladie_id', referencedColumnName: 'id_maladie', nullable: true, onDelete: 'SET NULL')]
    ...
    public function getProduitsRecommandes(): ?string
    {
        return $this->produitsRecommandes;
    }

    public function setProduitsRecommandes(?string $produitsRecommandes): self
    {
        $this->produitsRecommandes = $produitsRecommandes;

        return $this;
    }

    public function getConseilsPrevention(): ?string
    {
        return $this->conseilsPrevention;
    }

    public function setConseilsPrevention(?string $conseilsPrevention): self
    {
        $this->conseilsPrevention = $conseilsPrevention;
    ...
    public function setDureeTraitement(?string $dureeTraitement): self
    {
    ...
    public function getFeedbackPositive(): ?int
    {
        return $this->feedbackPositive;
    }

    public function setFeedbackPositive(int $feedbackPositive): self
    {
    ...
    public function getFeedbackNegative(): ?int
    {
        return $this->feedbackNegative;
    }

    public function setFeedbackNegative(int $feedbackNegative): self
    {
    ...
    public function setLastUserId(?int $lastUserId): self
    {
