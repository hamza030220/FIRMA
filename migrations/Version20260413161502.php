 ...
 */
final class Version20260413161502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX uniq_solution_user_vote ON solution_traitement_vote');
        ...
        $this->addSql('DROP INDEX idx_6d76d7a7424e4e4b ON solution_traitement_vote');
        $this->addSql('CREATE INDEX IDX_59EA35418400BB71 ON solution_traitement_vote (solution_traitement_id)');
        $this->addSql('DROP INDEX idx_6d76d7a4fb88e14f ON solution_traitement_vote');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX uniq_solution_user_vote ON solution_traitement_vote (solution_traitement_id, utilisateur_id)');
        $this->addSql('DROP INDEX idx_59ea35418400bb71 ON solution_traitement_vote');
        $this->addSql('CREATE INDEX IDX_6D76D7A7424E4E4B ON solution_traitement_vote (solution_traitement_id)');
        $this->addSql('DROP INDEX idx_59ea3541fb88e14f ON solution_traitement_vote');
        $this->addSql('CREATE INDEX IDX_6D76D7A4FB88E14F ON solution_traitement_vote (utilisateur_id)');
