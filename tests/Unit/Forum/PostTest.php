...
class PostTest extends TestCase
{
    ...
    public function testInitialState(): void
    {
        ...
        $this->assertNull($this->post->getExternalReference());
    ...
    {
        $result = $this->post->setImageUrl('uploads/posts/post-1.jpg');

        $this->assertSame('uploads/posts/post-1.jpg', $this->post->getImageUrl());
        $this->assertSame($this->post, $result);

        $this->post->setImageUrl(null);
        $this->assertNull($this->post->getImageUrl());
    }

    public function testSetAndGetExternalReference(): void
    {
        $result = $this->post->setExternalReference('java-post-001');

        $this->assertSame('java-post-001', $this->post->getExternalReference());
        $this->assertSame($this->post, $result);

        $this->post->setExternalReference(null);
        $this->assertNull($this->post->getExternalReference());
    }
